...
const PROTEIN_PER_100G: [string, number][] = [
  ...
  ['まぐろ', 26], ['マグロ', 26], ['かつお', 25], ['カツオ', 25], ['鮭', 22], ['サケ', 22], ['サーモン', 20], ['さば', 21], ['ぶり', 21],
  ['あじ', 20], ['いわし', 19], ['さんま', 18], ['たら', 18], ['カレイ', 20], ['銀だら', 14],
  ['シーフードミックス', 15], ['白身魚', 19], ['さわら', 20], ['ししゃも', 21], ['明太子', 21], ['たらこ', 24],
  ['しらす', 15], ['ちりめんじゃこ', 40], ['エビ', 19], ['イカ', 18], ['たこ', 16],
  ['ホタテ', 14], ['あさり', 6], ['しじみ', 7], ['牡蠣', 7], ['カニカマ', 12],
  ['ちくわ', 12], ['かまぼこ', 12], ['はんぺん', 10], ['さつま揚げ', 13], ['ツナ缶', 18],
  ['サバ缶', 21], ['サバ水煮缶', 21], ['さば水煮缶', 21], ['焼き鳥缶', 16],
  ['ライスペーパー', 1], ['おからパウダー', 25], ['プロテイン', 80],
  ['卵', 12], ['うずら卵', 13], ['卵黄', 16],
